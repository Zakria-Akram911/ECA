...
const Organize = (props: any) => {
  ...
  return (
    <Box>
      <Box>
        <Typography variant="h6" sx={{fontWeight: "350", fontFamily:"myAvenirBold", fontSize:"16px"}}>Organise</Typography>
        ...
        >
          <Box>
            ...
            >
              ...
              >
                <Typography paragraph sx={{ color: "white",fontSize: "14px" , fontFamily:"myAvenirLight"}}>
                ...
                <FormControl sx={{}}>
                  ...
                  >
                    {props.categoryList?.map((category: any) => (
                      <MenuItem value={category.category}  sx={{ color: "white", bgcolor:"black",fontSize: "14px" , 
                ...
                <FormControl sx={{}}>
                  ...
                  >
                    {subCategoryList?.map((category: any) => (
                      <MenuItem value={category}  sx={{ color: "white", bgcolor:"black",fontSize: "14px" , 
                      fontFamily:"myAvenirLight" ,
                      "& .MuiPaper-root": {
                        backgroundColor: "black"
                      },
                    ...
                    '&.Mui-selected': { color: "black",   bgcolor:"white"},
                    '&.Mui-selected: hover': { color: "black",   bgcolor:"white"} }}>{category}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
              </Box>
          ...
          <Box>
            ...
            <Box>
              <TextField
                placeholder="E.g 001"
                sx={{ "& fieldset": { border: 'none' }, width: "100px", fontSize: "13px" , bgcolor:"#FFF" ,borderRadius:"3px",border: "0.5px solid #939393"
