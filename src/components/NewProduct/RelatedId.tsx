...
const RelatedId = (props: any) => {
  ...
  useEffect(() => {
    async function getRelatedIds() {
      let resp = await getRelatedID();
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {(Array.isArray(props.relatedId)
                    ? props.relatedId.join(", ")
                    : "Related ID") || "Add Related ID"}
                </Typography>
              </Box>
              <Box>
                <FormControl sx={{}}>
                  <Select
                    value={
                      Array.isArray(props.relatedId) ? props.relatedId : []
                    }
