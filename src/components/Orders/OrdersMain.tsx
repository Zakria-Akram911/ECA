      ...
      <Grid item>
        <Button
          ...
          sx={{
            ...
            border: `${orders === "new" ?  "0.5px solid #3D0871": "0.5px solid #DADADA"}`,
            boxShadow: `${orders === "new" ? "0px 2px 6px 0px rgba(0, 0, 0, 0.07)":"none"}`,
      ...
      <Grid item>
        <Button
          ...
          sx={{
            ...
            border:  `${orders === "working" ?  "0.5px solid #3D0871": "0.5px solid #DADADA"}`,
            boxShadow: `${orders === "working" ? "0px 2px 6px 0px rgba(0, 0, 0, 0.07)":"none"}`,
            textTransform: "math-auto",
            fontSize: "16px",
            p: "5px 25px",
            borderRadius: "0",
      ...
      <Grid item>
        <Button
          ...
          sx={{
            ...
            boxShadow: `${orders === "dispatched" ? "0px 2px 6px 0px rgba(0, 0, 0, 0.07)":"none"}`,
            border: `${orders === "dispatched" ?  "0.5px solid #3D0871": "0.5px solid #DADADA"}`,
            textTransform: "math-auto",
            fontSize: "16px",
            p: "5px 25px",
